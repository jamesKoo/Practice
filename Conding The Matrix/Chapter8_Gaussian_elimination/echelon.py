...
def transformation_rows(rowlist_input, col_label_list = None, is_GF2=True):
...
def transformation(A, col_label_list = None, is_GF2=True):
    ...
    M_rows = transformation_rows(rowlist, col_label_list, is_GF2)
